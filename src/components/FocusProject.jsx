...
export default function FocusProject() {
  ...
  return (
    <div className="bg-[#050000] font-sans selection:bg-blue-500/50 relative overflow-hidden text-zinc-100 min-h-screen">
      ...
      <section className="relative w-full min-h-[90vh] flex flex-col items-center justify-center pt-32 pb-16 px-4 md:px-8 z-10 gap-8">
        ...
        <motion.div
          ...
          className="w-full max-w-[600px] md:max-w-[800px] lg:max-w-[1000px] xl:max-w-[1200px] 2xl:max-w-[1400px] relative flex flex-col items-center justify-center"
        >
          {/* CONTENEDOR RELATIVO PARA EMPALMAR IMAGEN Y VIDEO VERTICAL */}
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto flex flex-col gap-24 z-10 relative">
        ...
        >
          <img
            ...
            alt="Focus Foto 2"
            className="w-full max-w-lg rounded-[2rem] object-contain shadow-2xl"
          />
        </motion.div>
      ...
      <div className="my-16 py-8 overflow-hidden bg-blue-600 flex -rotate-2 scale-110 shadow-2xl origin-center">
        <motion.div
